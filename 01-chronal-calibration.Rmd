...
OK, let's just keep making the vector bigger until __at least__ one frequency is repeated. Also, let's just go back to base R.
...
The new vector is `r length(growing_vector)/length(puzzle_input)` times the size of the original input vector.
...
Which allows me to get the __first__ frequency that is repeated twice:
